...
const teams = [
  {
    ...
    accent: 'linear-gradient(160deg, rgba(111, 125, 255, 0.95), rgba(148, 158, 255, 0.8))',
    visual: 'radial-gradient(circle at 22% 24%, rgba(111, 125, 255, 0.38), transparent 58%), radial-gradient(circle at 78% 76%, rgba(148, 158, 255, 0.32), transparent 62%)',
  },
  {
    id: 'algolab',
    ...
    skills: ['Algoritma'],
    accent: 'linear-gradient(160deg, rgba(111, 125, 255, 0.92), rgba(138, 149, 255, 0.78))',
    visual: 'radial-gradient(circle at 24% 26%, rgba(111, 125, 255, 0.36), transparent 58%), radial-gradient(circle at 76% 74%, rgba(138, 149, 255, 0.3), transparent 60%)',
  },
  {
    id: 'chainlab',
    ...
    skills: ['Blockchain'],
    accent: 'linear-gradient(160deg, rgba(111, 125, 255, 0.9), rgba(132, 143, 255, 0.76))',
    visual: 'radial-gradient(circle at 20% 28%, rgba(111, 125, 255, 0.34), transparent 56%), radial-gradient(circle at 80% 72%, rgba(132, 143, 255, 0.28), transparent 58%)',
  },
  {
    id: 'gamelab',
    ...
    accent: 'linear-gradient(160deg, rgba(111, 125, 255, 0.88), rgba(126, 137, 255, 0.74))',
    visual: 'radial-gradient(circle at 26% 22%, rgba(111, 125, 255, 0.32), transparent 56%), radial-gradient(circle at 74% 78%, rgba(126, 137, 255, 0.27), transparent 60%)',
  },
  {
    id: 'mobilab',
    ...
    skills: ['Flutter'],
    accent: 'linear-gradient(160deg, rgba(111, 125, 255, 0.86), rgba(120, 131, 255, 0.72))',
    visual: 'radial-gradient(circle at 28% 24%, rgba(111, 125, 255, 0.3), transparent 54%), radial-gradient(circle at 72% 76%, rgba(120, 131, 255, 0.26), transparent 58%)',
  },
  {
    id: 'skysec',
    ...
    accent: 'linear-gradient(160deg, rgba(111, 125, 255, 0.84), rgba(114, 125, 255, 0.7))',
    visual: 'radial-gradient(circle at 18% 22%, rgba(111, 125, 255, 0.28), transparent 52%), radial-gradient(circle at 82% 78%, rgba(114, 125, 255, 0.24), transparent 56%)',
  },
  {
    id: 'skysis',
    ...
    accent: 'linear-gradient(160deg, rgba(111, 125, 255, 0.82), rgba(108, 119, 255, 0.68))',
    visual: 'radial-gradient(circle at 30% 28%, rgba(111, 125, 255, 0.26), transparent 52%), radial-gradient(circle at 70% 72%, rgba(108, 119, 255, 0.22), transparent 56%)',
  },
  {
    id: 'weblab',
    ...
    accent: 'linear-gradient(160deg, rgba(111, 125, 255, 0.8), rgba(102, 113, 255, 0.66))',
    visual: 'radial-gradient(circle at 32% 26%, rgba(111, 125, 255, 0.24), transparent 50%), radial-gradient(circle at 68% 74%, rgba(102, 113, 255, 0.2), transparent 54%)',
  },
]
